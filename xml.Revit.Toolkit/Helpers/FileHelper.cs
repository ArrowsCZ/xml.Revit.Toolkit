...
public static class FileHelper
{
    ...
    /// <param name="initDir"></param>
    /// <returns></returns>
    public static string[] SelectFiles(string tpFilter = "Revit样板文件 (*.rte)|*.rte", string initDir = null)
    {
        OpenFileDialog openFileDialog = new()
        {
            Title = "请多选文件",
    ...
    public static void UpdateVersion(string fileName)
    {
        try
        {
            ...
            var assemblyVersionElement = doc.Root.Element("PropertyGroup")?.Element("AssemblyVersion");
