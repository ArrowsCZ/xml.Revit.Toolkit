    ...
    public abstract class XmlExternalCommand : IExternalCommand, IExternalCommandAvailability
    {
        ...
        )
        {
            try
            {
                ...
                if (!currentType.HasAttribute<Attributes.XmlAttribute>())
                {
                    XmlDoc.Print(
                ...
                XmlExternalApplication._revitTaskService ??= new RevitTaskService(XmlDoc.UIapp);
                if (!XmlExternalApplication._revitTaskService.HasInitialized)
                {
                    XmlExternalApplication._revitTaskService.Initialize();
                }
